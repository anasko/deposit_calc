...
void inpData( int *summ, int *time){
int s,t;
...
void CheckData(int summ, int time){
...
//printf("!=%d", summ);
   ...
   if((time<=365)&&(summ>=1000)){
            ...
            if((time<=30)&&(time>=0))
                ...
                printf("Cумму вклада=%d", summ+summ*2/100);

            else if((time<=240)&&(time>=121))

                printf("Cумму вклада=%d", summ+summ*6/100);

            else if((time<=365)&&(time>=241))

                printf("Cумму вклада=%d", summ+summ*12/100);
